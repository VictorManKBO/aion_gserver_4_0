...
public final class PlayerEnterWorldService {
	...
	private static final String serverName = "\n[color:\u0414\u043e\u0431\u0440\u043e;0 1 1] [color:\u043f\u043e\u0436\u0430\u043b;0 1 1][color:\u043e\u0432\u0430\u0442\u044c;0 1 1][color:!;0 1 1]\n";
	//private static final String serverName = "\u0414\u043e\u0431\u0440\u043e \u043f\u043e\u0436\u0430\u043b\u043e\u0432\u0430\u0442\u044c \u043d\u0430 \u0441\u0435\u0440\u0432\u0435\u0440 " + GSConfig.SERVER_NAME + "!";
	//private static final String serverIntro = "\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430 \u0437\u0430\u043f\u043e\u043c\u043d\u0438\u0442\u0435! \n\u0410\u0434\u043c\u0438\u043d\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044f \u0441\u0435\u0440\u0432\u0435\u0440\u0430 " + GSConfig.SERVER_NAME + " \u043d\u0438\u043a\u043e\u0433\u0434\u0430 \u043d\u0435 \u0431\u0443\u0434\u0435\u0442 \u0441\u043f\u0440\u0430\u0448\u0438\u0432\u0430\u0442\u044c \u0432\u0430\u0448\u0438 \u043f\u0430\u0440\u043e\u043b\u0438.\n";
	...
	static {
		...
		//infoBuffer = "\u0420\u0435\u0439\u0442\u044b \u0441\u0435\u0440\u0432\u0435\u0440\u0430 :\n\u041e\u043f\u044b\u0442 : " + RateConfig.XP_RATE + "\n\u041a\u0432\u0435\u0441\u0442\u044b : " + RateConfig.QUEST_XP_RATE + "\n\u0414\u0440\u043e\u043f : " + RateConfig.DROP_RATE;
		//infoBuffer += "\u0418\u043b\u0438 \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0438\u0442\u044c \u043f\u0440\u0435\u043c\u0438\u0443\u043c  \u0438\u043b\u0438 \u0432\u0438\u043f \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u044b \u0441 \u043f\u043e\u043c\u043e\u0449\u044c\u044e \u0441\u043c\u0441.\n";

		alBuffer = "\u041f\u0440\u0438\u044f\u0442\u043d\u043e\u0439 \u0438\u0433\u0440\u044b \u043d\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0435 Aion FLY!\n";
		//alBuffer += "\u0421\u043e\u0437\u0434\u0430\u043d\u043e \u041a\u043e\u043c\u0430\u043d\u0434\u043e\u0439 aion-fly.ru\n";
		//alBuffer += "\u0420\u0430\u0437\u0440\u0430\u0431\u043e\u0442\u043a\u0430 2013 \u0433.\n";
	...
	public static final void startEnterWorld(final int objectId, final AionConnection client) {
		...
		if (lastOnline != null && client.getAccount().getAccessLevel() < AdminConfig.GM_LEVEL) {
			...
			if (timeNow - lastOnline.getTime() < (GSConfig.CHARACTER_REENTRY_TIME * 1000)) {
				client.sendPacket(new SM_ENTER_WORLD_CHECK((byte) 6)); // 20 sec time
				return;
			}
			else {
				log.warn("Now time " + timeNow + " lastOnline " + lastOnline.getTime() + " delta " + GSConfig.CHARACTER_REENTRY_TIME * 1000);
			}
		}
		else {
			log.warn("ERROR 1");
			...
			if (player.isGM()) {
				if (AdminConfig.INVULNERABLE_GM_CONNECTION || AdminConfig.INVISIBLE_GM_CONNECTION
					...
					if (AdminConfig.INVULNERABLE_GM_CONNECTION) {
						...
						PacketSendUtility.sendMessage(player, MuiService.getInstance().getMessage("INVULNERABLE_GM_CONNECTION"));
					}
					if (AdminConfig.INVISIBLE_GM_CONNECTION) {
						...
						PacketSendUtility.sendMessage(player, MuiService.getInstance().getMessage("INVISIBLE_GM_CONNECTION"));
					}
					if (AdminConfig.ENEMITY_MODE_GM_CONNECTION.equalsIgnoreCase("Neutral")) {
						player.setAdminNeutral(3);
						player.setAdminEnmity(0);
						PacketSendUtility.sendMessage(player, MuiService.getInstance().getMessage("NEUTRAL_GM_CONNECTION"));
					}
					if (AdminConfig.ENEMITY_MODE_GM_CONNECTION.equalsIgnoreCase("Enemy")) {
						player.setAdminNeutral(0);
						player.setAdminEnmity(3);
						PacketSendUtility.sendMessage(player, MuiService.getInstance().getMessage("ENEMYTY_GM_CONNECTION"));
					}
					if (AdminConfig.VISION_GM_CONNECTION) {
						player.setSeeState(CreatureSeeState.SEARCH10);
						PacketSendUtility.broadcastPacket(player, new SM_PLAYER_STATE(player), true);
						PacketSendUtility.sendMessage(player, MuiService.getInstance().getMessage("VISION_GM_CONNECTION"));
					}
					if (AdminConfig.WHISPER_GM_CONNECTION) {
						player.setUnWispable();
						PacketSendUtility.sendMessage(player, MuiService.getInstance().getMessage("WHISPER_GM_CONNECTION"));
					}
					PacketSendUtility.sendMessage(player, "=============================");
				}
	...
	private static void showPremiumAccountInfo(AionConnection client, Account account) {
		...
		if (membership > 0) {
			...
			client.sendPacket(new SM_MESSAGE(0, null, "\u0421\u0442\u0430\u0442\u0443\u0441 \u0432\u0430\u0448\u0435\u0433\u043e \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u0430 :  " + accountType, ChatType.GOLDEN_YELLOW));
		}
	}
