...
public class SteelRoseQuartersSoloInstance extends GeneralInstanceHandler {
    ...
    public void onInstanceCreate(WorldMapInstance instance) {
        ...
        switch (rnd) { //Nerukiki The Timid.
            case 1:
                spawn(230649, 517.2308f, 506.71335f, 951.7029f, (byte) 114);
                break;
            case 2:
                spawn(230649, 524.70435f, 519.89136f, 952.4762f, (byte) 55);
                break;
            case 3:
                spawn(230649, 473.1518f, 575.4152f, 958.0783f, (byte) 53);
                break;
            case 4:
                spawn(230649, 461.15442f, 512.30054f, 952.54895f, (byte) 5);
                break;
        }
    }
